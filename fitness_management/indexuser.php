        ...
        <div class="box-shadow">
          <div class="wrap block-2">
            ...
            <div class="col-2">
              ...
              <ul class="list-1">
                <li><a href="timetableu.php">Group Fitness</a></li>
                <li><a href="timetableu.php">Personal Training</a></li>
                <li><a href="timetableu.php">Aquatic Center</a></li>
                <li><a href="timetableu.php">Senior Memberships</a></li>
                <li><a href="timetableu.php">PRO Rehabilitation</a></li>
              </ul>
